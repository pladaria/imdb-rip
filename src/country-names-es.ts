/** ISO 3166-1 alpha-2 country codes mapped to Spanish names. */
export const COUNTRY_NAMES_ES: Readonly<Record<string, string>> = {
    ...
    // Historical or withdrawn codes that may appear in older movies.
    ...
    PU: 'Islas del Pacífico de los Estados Unidos',
